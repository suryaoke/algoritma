...
@section('content')
    ...
    <div class="page-content">
        <div class="mb-3 intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            {!! Form::open(['role' => 'form', 'route' => 'admin.gurus', 'method' => 'get', 'class' => 'sm:flex']) !!}
            @if (Auth::user()->role == '1')
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <a href="{{ route('admin.guru.create') }}" class="btn btn-primary shadow-md mr-2">Tambah Data</a>
                </div>
            @endif
                                    ...
                                    @foreach ($gurus as $key => $guru)
                                        <tr>
                                            ...
                                            @if (Auth::user()->role == '1')
                                                <td class="">
                                                    <a id="delete"
                                                        href="{{ route('admin.guru.delete', $guru->id) }}"
