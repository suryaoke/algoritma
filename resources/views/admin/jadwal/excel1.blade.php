<table>
    ...
    <thead>
        ...
        <tr>
            <th colspan="7" style="text-align: center; font-weight: bold; font-size: 14px;"> SMK MUHAMMADIYAH 1
                PEKANBARU</th>
            ...
            <tr style="border: 2px solid black;">
                @foreach ($groupedSchedules as $classRoom => $schedulesByClassRoom)
                    @php
                        ...
                        $isUpacara = $schedule && $schedule['guru_code'] === 'UPACARA' ? true : $schedule && $schedule['guru_code'] === 'MUHADARAH';
                    ...
                    @if ($schedule)
                        ...
                        @if ($isUpacara)
                            <td colspan="3"
                                @if ($isUpacara) style="border: 2px solid black; text-align: center; background-color: gray;" @endif>
